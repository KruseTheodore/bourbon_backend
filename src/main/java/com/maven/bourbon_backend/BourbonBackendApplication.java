...
public class BourbonBackendApplication {
	...
	public CorsFilter corsFilter(){
		...
		corsConfiguration.setAllowedHeaders(Arrays.asList("application/json", "Origin","ContentType", "Access-Control-Allow-Origin", "Content-Type", "Accept", "Authorization", "Origin, Accept", "X-Requested_With", "Access-Control-Request-Method", "Access-Control-Request-Headers"));
